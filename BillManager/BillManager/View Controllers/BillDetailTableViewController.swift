...
class BillDetailTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    private func presentNeedAuthorizationAlert() {
            let alert = UIAlertController(
                ...
                message: "Reminders are unavailable unless you grant notification permissions in iOS Settings.",
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if remindSwitch.isOn {
            ...
            bill.scheduleReminder(remindDatePicker.date) { scheduledBill in
                if scheduledBill.notificationID == nil {
